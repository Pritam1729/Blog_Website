...
app.get("/",function(req,res){
    blogs = Blog.find({}).then(function(data){
        res.render("home",{homeStarting : homeStartingContent,posts : data});
    })
})
...
app.get("/posts/:item",function(req,res){
  var storeTitle = req.params.item;
  Blog.findOne({'_id' : storeTitle}).then(function(data){
      // console.log(data)
